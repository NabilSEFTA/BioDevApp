...
public class DAOFactory {
	private static final String FICHIER_PROPERTIES ="/com/annuaire/dao/dao.properties";
	...
	public static DAOFactory getInstance() throws DAOConfigurationException 
	   {
			...
			*/
			public CategorieInstitutionDao getCategorieInstitutionDao() 
			{
				return new CategorieInstitutionDaoImpl( this );
			}
