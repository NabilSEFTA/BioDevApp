...
import RGforest.ClassificationForestDaoImpl;

/**
 * Servlet implementation class EmbranchementsForest
 */
@WebServlet("/EmbranchementsForest")
public class EmbranchementsForest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmbranchementsForest() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP/RGForest/embranchementsForest.jsp").forward(request, response);
	}
