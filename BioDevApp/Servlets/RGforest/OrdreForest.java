...
/**
 * Servlet implementation class OrdreForest
 */
@WebServlet("/OrdreForest")
public class OrdreForest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP/RGForest/ordreForest.jsp").forward(request, response);
	}
