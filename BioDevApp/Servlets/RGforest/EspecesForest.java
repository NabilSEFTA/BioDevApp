...
/**
 * Servlet implementation class EspecesForest
 */
@WebServlet("/EspecesForest")
public class EspecesForest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EspecesForest() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/JSP/RGForest/especesForest.jsp").forward(request, response);
