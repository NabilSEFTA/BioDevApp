...
<body>
  ...
  <!--/ Nav End /-->
  	...
  	<div id="contenu" class="text-center border border-light p-5 form">
	  	...
	  	<form  class=" form-a" method="post" action="ModifierInst?id_inst=${inst.id_inst }" enctype="multipart/form-data">
  		<p class="h4 mb-4">Modifier une Institution</p>
  		<div class="form-row mb-4">
        <div class="col-lg 6">
           
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Acronyme" 
            name="acronyme_inst" id="acronyme_inst" value ="${inst.acronyme}">
        </div>
           
            <div class="form-group col-lg 6">
            
              <select class="form-control form-control-lg form-control-a" name="cat_inst" id="cat_inst" value="${inst.id_cat_inst }">
      ...
      <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nom de l'institution" 
            name="nom_inst" id="nom_inst" value ="${inst.nom_inst}">
            ...
            <div class="form-group">
              <input  class="form-control" name="description_inst"  id="description_inst" 
              data-rule="required"  placeholder="Description de l'institution" value ="${inst.description_inst}"/>
        ...
        <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Numéro de téléphone" 
            value ="${inst.tel_inst}" name="tel_inst" id="tel_inst">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Fax de l'institution" 
            name="fax_inst" id="fax_inst" value ="${inst.fax_inst}">
        </div>
      </div>
      <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Adresse E-mail" 
            name="mail_inst" id="mail_inst" value ="${inst.adresse_inst}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Lien du site Web" 
            name="lien_site" id="lien_site" value ="${inst.lien_site}">
        </div>
        </div>
        <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Adresse de l'institution"
             name="adresse_inst" id="adresse_inst" value ="${inst.adresse_inst}">
        </div>
      </div>
        ...
        <div id="buttonSubmit" class="col-md-12">
                    <button type="submit" class="btn btn-a" >Valider les modifications</button>
