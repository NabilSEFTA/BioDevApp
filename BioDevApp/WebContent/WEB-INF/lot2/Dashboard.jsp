 ...
 <div id="wrapper">
	  ...
	  <header id="header">
	    <div class="container">
	      ...
	      <div id="logo" class="pull-left" style="text-align: right">
	        <h1 style="position: absolute;right:50px;"><a href="#intro" class="scrollto" >Bio.DEV</a></h1>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a onclick="afficherArticle()" >ARTICLES</a>
                </li>
                <li>
                    <a onclick="afficherNews()">NEWS</a>
                </li>
                <li>
                    <a onclick="afficherEvent()">EVENEMENTS</a>
                </li>
                <!--  
                <li>
                    <a href="#">Team</a>
	...
	<form action="dashboard" method="post" >
    	<input type="Texte"  name="ContenuArticle"  value="chahrazed"  >
		<input type="submit"   value="Ajouter" style="" >
	</form>  -->
