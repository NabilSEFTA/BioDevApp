...
<!--==========================
  ...
  <div>
  	...
  	<div class="col-lg-9 col-md-12 container1">
		...
		<h1 class="title-article"><c:out value="${requestScope.TitreEvent}" /></h1>
		<div class="meta-data" style="text-align: left;margin-left:180px;">
        	<span class="longDate dateNews"> <c:out value="${requestScope.DateEvent}" /></span> 
        </div>
		<blockquote class="ludwig">
			<c:out value="${requestScope.DescriptionEvent}" />
	    </blockquote>
		<img alt="" src="<c:out value="${requestScope.PathEvent}" />" class="img-article" >

  		<p class="texte-article">	
  								<c:out value="${requestScope.ContenuEvent}" />						
