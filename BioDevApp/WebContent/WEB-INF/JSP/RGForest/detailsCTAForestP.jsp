						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
						        ...
						        <button onClick="location.href='ValiderCTAForest';" type="button" class="btn btn-success">Valider</button>
						      </div>
						    </div>
						  </div>
						</div>
			      		<img align="right" src="images/RGForest/cta.png" style="height:20%; weight:20%;">
			     	</td>
			     </tr>
			    </tbody>
			    </table>
