...
<body>
	...
	<div class="container" style="color:#4D4F5C;">
		<div>
			<h2 style="text-align:center;">RG Forestieres --> ${ sessionScope.nom1} --> ${ sessionScope.nom2}</h2><br><br>
			...
			<h6 style="text-align:left;">${sessionScope.rg.getNom_latin()}</h6>
			...
			<table class="table">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td>
			      		${sessionScope.rf.getId_RGForestiere()}
				  </td>
			    </tr>
			    <tr>
			      ...
			      <td>
						...
						Autres noms scientifiques parfois utilisés,mais non valides	:	${sessionScope.rf.getAutres_noms()}<br>                          
			      </td>
			    </tr>
			    <tr>
			      <th scope="row">IMAGES</th>
			      <td class="text-center">
			      		<img src="${sessionScope.rf.getImage1()}" class="img-thumbnail" style="height:400px; weight:500px;">			  
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td>
			      		Quantité O2 : ${sessionScope.em.getQ_o2()}%<br>
			      		Quantité CO2 : ${sessionScope.em.getQ_co2()}%<br>
			      		Température : ${sessionScope.em.getTemperature()}°C<br>
			      		Gravite : ${sessionScope.em.getGravite()}%<br>
			      </td>
			    </tr>
			    <tr>
			      ...
			      <td>
			      		...
			      		Régions    : ${sessionScope.lf.getRegion()}<br>
			      		Wilayas    : ${sessionScope.lf.getWilaya()}<br>
			      		Carte : <br><br>
			      </td>
			    </tr>
			  </tbody>
