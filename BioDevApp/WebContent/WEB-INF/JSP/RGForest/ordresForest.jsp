...
<head>
<meta charset="UTF-8">
<title>OrdresForest/${sessionScope.nom1}</title>
</head>
<body>
	...
	<h2 style="text-align:center; color:#8F8F8F">Plantes _ ${ sessionScope.nom1}</h2><br><br>
	
	<div class="container">
		<div class="row">
			<c:forEach var="i" begin="1" end="${ sessionScope.listClassifications2.size() }" step="1">
		    <div style="margin:0 ; margin-left:auto ; margin-right:auto; text-align: center;" class="col-md-3">
		      <div class="thumbnail text-center">
		          <img src="${ sessionScope.listClassifications2.get(i-1).getImage()}" alt="Lights" style="width:70%">
		          
		          	<form method="GET" action="OrdreForest">
			          <div class="caption">
