...
<body>
	...
	<h4 style="text-align:center; color:#8F8F8F">RG Forestieres --> ${sessionScope.nom1} --> ${sessionScope.nom2} --> ${sessionScope.nom3} (Espèces)</h4><br><br>
		    ...
		    <div class="col-md-3">
		      <div class="thumbnail text-center">
		          <img src="${sessionScope.listRF.get(i-1).getImage()}" alt="Lights" class="roundedImageShadow">
		          	...
		          	<form method="GET" action="DetailsPlante">
			          <div class="caption">
			          	<input type="hidden" name="numESPP" value="${i}">
			          	<input type="hidden" name="idESPP" value="${sessionScope.listRF.get(i-1).getId_RGForestiere()}">
			          	<br>
