...
<body>
	...
	<h3 style="text-align:center; color:#8F8F8F">RG Forestieres --> ${ sessionScope.nom1} --> ${ sessionScope.nom2} (Familles)</h3><br><br>
		    ...
		    <div class="col-md-3">
		      <div class="thumbnail text-center">
		          <img src="${ sessionScope.listClassifications3.get(i-1).getImage()}" alt="Lights" class="roundedImageShadow"><br><br>
		          	...
		          	<form method="GET" action="EspecesPlante">
			          <div class="caption">
			          	<input type="hidden" name="numFam" value="${i}">
			          	<input type="hidden" name="idFam" value="${sessionScope.listClassifications3.get(i-1).getId()}">
