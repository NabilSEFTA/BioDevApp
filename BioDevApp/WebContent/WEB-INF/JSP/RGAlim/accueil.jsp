    ...
    <section id="more-features" class="section-bg">
      <div class="container">
        ...
        du type de « microbe » étudié
              ...
              <a class="cta-btn1" href="#" onclick="document.getElementsByName('RG-microorganismes')[0].click();">En savoir plus</a>
            </div>
         ...
         Différents produits peuvent être générés à partir des ressources forestières. <br> <br> <br>
             ...
             <div class="  cta-btn-container text-right" style="  width:300px;">
              <a class="cta-btn1" href="#" style="  margin-right:-150px;" onclick="document.getElementsByName('RG-foret')[0].click();">En savoir plus</a>
            </div>
            </div>
          </div>
      ...
      <div class="col-lg-3">
         ...
         ou commerciales qui sont issues de la domestication et de la sélection. <br> <br>
              ...
              <div class=" cta-btn-container text-right" style="margin-left:-350px;">
              <a class="cta-btn1" href="#"  onclick="document.getElementsByName('RG-faune')[0].click();">En savoir plus</a>
            </div>
            </div>
          </div>
          <div class="col-lg-3">
         ...
         l’agriculture.  <br> <br> <br> <br> <br>
              ...
              <div class="  cta-btn-container text-right" style="margin-left:-350px;">
              <a class="cta-btn1" href="#" onclick="document.getElementsByName('RG-agriculture')[0].click();">En savoir plus</a>
            </div>
            </div>
          </div>
        ...
        incurables et chroniques.
              ...
              <div class="  cta-btn-container text-right" style="  width:300px;">
              <a class="cta-btn1" href="#" style="  margin-right:-150px;" onclick="document.getElementsByName('RG-marine')[0].click();">En savoir plus</a>
            </div>
            </div>
          </div>
      ...
      <div class="container">
       ...
       la perte de la biodiversité. De nombreuses institutions éxistent en Algérie et qui ont une relation directe ou indirecte avec l'APA. 
        <section class="centered-container text-center">
          <a class="link link--arrowed"  onclick="document.getElementsByName('Annuaire')[0].click();" >Acceder à l'annuaire
