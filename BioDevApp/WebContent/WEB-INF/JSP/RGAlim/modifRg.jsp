...
<body id="page-top">
    ...
    <form  class="text-center border border-light p-5 form-a" action="#!" method="post" id="form">
      ...
      <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nom Latin" name="nomLatin" value="${ressource.nomLatin}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nom Arabe" name="nomArabe" value="${ressource.nomArabe}">
        </div>
      </div>
      <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nom Amazigh" name="nomAmazigh" value="${ressource.nomAmazigh}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nom Français" name="nomFrancais" value="${ressource.nomFrancais}">
        </div>
        </div>
 
            <div class="form-group">
              <textarea  class="form-control" name="descriptionRessouce" cols="45" rows="8" data-rule="required"  placeholder="Description de la RG" value="${ressource.description}"></textarea>
        ...
        <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Arrosage" name="arrosage" value="${ressource.arrosage}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Hauteur Maturité" name="hauteurMaturite" value="${ressource.hauteurMaturité}">
        </div>
      </div>
      <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Largeur Maturité" name="largeurMaturite" value="${ressource.largeurMaturité}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Niveau de soin" name="niveauSoin" value="${ressource.niveauSoin}">
        </div>
        </div>
        <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Periode de floraison" name="periodeFloraison" value="${ressource.periodeFloraison}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Rusticité" name="rusticite" value="${ressource.rusticite}">
        </div>
      </div>
      <div class="form-row mb-4">
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Saison d'interet" name="saisonInteret" value="${ressource.saisonInteret}">
        </div>
        <div class="col">
            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Utilisation en jardin" name="utilisationjardin" value="${ressource.utilisationEnJardin}">
        </div>
        </div>
