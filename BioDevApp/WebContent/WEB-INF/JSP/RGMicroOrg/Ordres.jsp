...
<!--/ Intro Single star /-->
  ...
  <section class="property-grid grid">
      <div class="container">
      <div class="row">
       <c:forEach var="i" begin="1" end="${sessionScope.listRGCM4.size()}" step="1">
		        ...
		        <div class="col-md-4">
		          <div class="card-box-e ">
		            <div class="img-box-a card-shadow">
		              <img src="${sessionScope.listRGCM4.get(i-1).getImage() }" alt="" height="350" width="400">
		            </div>
		            <div class="card-overlay">
		              <div class="card-overlay-a-content">
		                <div class="card-header-a">
		                  <h2 class="card-title-a">
		                    <a href="GenresM?numOrdre=${i}">${sessionScope.listRGCM4.get(i-1).getNom() }</a>
		                  </h2>
		                </div>
		                <div class="card-body-a">
		                  <a href="GenresM?numOrdre=${i}" class="link-a">En savoir plus
