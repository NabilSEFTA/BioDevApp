...
<%@include file="./Header.jsp" %>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="${sessionScope.rgEsp.getImage()}" class="d-block w-100" alt="...">
    </div>
                ...
                <div class="summary-list">
                  <ul class="list">
                    <li class="d-flex justify-content-between">
                      ...
                      <span> ${sessionScope.rgEsp.getNom_latin()} </span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Nom arabe:</strong>
                      <span>${sessionScope.rgEsp.getNom_arabe()}</span>
                    </li>      
                  </ul>
                </div>  
              ...
              <div class="property-summary">
                ...
                <div class="summary-list">
                  <ul class="list">
                    <li class="d-flex justify-content-between">
                      <strong>Forme:</strong>
                      <span> ${sessionScope.rgEsp.getForme()} </span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Respiration: </strong>
                      <span>${sessionScope.rgEsp.getRespiration()}</span>
                    </li>   
                     <li class="d-flex justify-content-between">
                      <strong>Pathogenie: </strong>
                      <span>${sessionScope.rgEsp.getPathogenie()}</span>
                    </li> 
                     <li class="d-flex justify-content-between">
                      <strong>Emplacement de l'ADN: </strong>
                      <span>${sessionScope.rgEsp.getEmplacement_adn()}</span>
                    </li>  
                    <li class="d-flex justify-content-between">
                      <strong>Coloration de gram: </strong>
                      <span>${sessionScope.rgEsp.getColoration_gram()}</span>
                    </li> 
                    <li class="d-flex justify-content-between">
                      <strong>Eco-système: </strong>
                      <span>${sessionScope.rgEsp.getEcosys()}</span>
                    </li>  
                  </ul>
                </div>
              </div>
      ...
      <div class="col-md-7 col-lg-7 section-md-t3">
              ...
              <div class="property-description">
                <p class="description color-text-a">
                     ${sessionScope.rgEsp.getDescription()}
               </p>
