  ...
  <section class="property-grid grid">
    <div class="container">
      <div class="row">
        ...
        <c:forEach var="i" begin="1" end="${sessionScope.listRGCM5.size()}" step="1">
		        <div class="col-sm-12">
		        ...
		        <div class="col-md-4">
		          <div class="card-box-e ">
		            <div class="img-box-a card-shadow">
		              <img src="${sessionScope.listRGCM5.get(i-1).getImage() }" alt="" height="350" width="400">
		            </div>
		              ...
		              <div class="card-overlay-a-content">
		                <div class="card-header-a">
		                  <h2 class="card-title-a">
		                    ...
		                    <a href="GenreM?numGenre=${i}">${sessionScope.listRGCM5.get(i-1).getNom() }</a>
		                  </h2>
		                </div>
		                <div class="card-body-a">
		                  <a href="GenreM?numGenre=${i}" class="link-a">En savoir plus
