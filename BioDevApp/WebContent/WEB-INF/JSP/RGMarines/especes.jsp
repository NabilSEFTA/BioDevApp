...
<body>
	...
	<h4 style="text-align:center; color:#8F8F8F">RG Marines --> ${sessionScope.nom1} --> ${sessionScope.nom2} --> ${sessionScope.nom3} (Espèces)</h4><br><br>
		      ...
		      <div class="thumbnail text-center">
		          <img src="${sessionScope.listRM.get(i-1).getImage()}" alt="Lights" class="roundedImageShadow">
			          ...
			          <div class="caption">
			          	...
			          	<br>
			          	<h5>${sessionScope.listRM.get(i-1).getNom_latin()}</h5>
			          	<br>
			          </div>
