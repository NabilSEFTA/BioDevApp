        ...
        <div class="col-sm-12">
         <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
            <div class="carousel-item-b">
              <img src="image/amphibien1.jpg" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="image/amphibien2.jpg" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="image/amphibien3.jpg" alt="">
            </div>
          </div>
          <div class="row justify-content-between">
              ...
              <div class="property-price d-flex justify-content-center foo">
                <div class="card-header-c d-flex">
                  ...
                  <div class="card-title-c align-self-center">
                    <h5 class="title-c">Les mollusques</h5>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-7 col-lg-7 section-md-t3">
              ...
              <div class="row section-t3">
                <div class="col-sm-12">
                  <div class="title-box-d">
                    <h3 class="title-d">Anatomie générales</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="row section-t3">
                <div class="col-sm-12">
                  <div class="title-box-d">
                    <h3 class="title-d">Coquille</h3>
                  </div>
                </div>
              </div>
              <div class="amenities-list color-text-a">
             
                  <p>Des glandes du manteau des Eumollusques se regroupent et sécrètent généralement une coquille calcaire, qui comprend, de l'extérieur vers l'intérieur :
                  ...
                  Cette couche interne, lorsque les lamelles sont suffisamment minces pour diffracter la lumière, constitue la nacre, et, indirectement, les perles fines.</p>
              ...
              <div class="amenities-list color-text-a">
                  ...
                  <p>Le système nerveux typique d'un mollusque comprend des ganglions cérébroà¯des (qui peuvent fusionner pour former un cerveau) reliés d'une part à  des ganglions pédieux, d'autre part à  des ganglions viscéraux, par un double collier périÅsophagien.</p>
              ...
              <div class="amenities-list color-text-a">
               ...
               <div class="row section-t3">
                <div class="col-sm-12">
                  <div class="title-box-d">
                    <h3 class="title-d">Les ordres d'amphibiens</h3>
                  </div>
                </div>
              </div>
              <div class="amenities-list color-text-a">
                <ul class="list-a no-margin">
                  ...
                  <li>archéogastéropodes</li>
                   <li>patellogastropodes</li>
                    <li>neomphaloàdes </li>
                     <li>caenogastropodes</li> 
                     <li>cyclonéritomorphes</li>
                      <li>Littorinimorph</li>
