      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">Connaissances Traditionelles Algériennes</span>
          </div>
        </div>
      ...
      <div class="row"> 
	        <div class="card-box-a">
	          <div class="col-md-4 col-lg-3">
	            <div class="img-box-a">
	              <img src="${sessionScope.rgcta.getImage()}" alt="" height="350" width="350">
	            </div>
	            </div>
	            </div>   
	            <div class="col-md-7 col-lg-7 section-md-t3">
		              <div class="row">
		                <div class="col-sm-12">
		                  <div class="title-box-d">
		                    <h3 class="title-d">
		                     ${sessionScope.rgcta.getIntitule()}</h3>
		                  </div>
		                </div>
		              </div>          
	                    ${sessionScope.rgcta.getBrevet()} 
		              <div class="Procaryotes">
		              ...
		              <div class="col-md-12" >
		              <a href="#">
		                 <button type="reset"  class="btn btn-a" >Cc</button>
		              </a>
		              </div>
	            </div>
          </div>
