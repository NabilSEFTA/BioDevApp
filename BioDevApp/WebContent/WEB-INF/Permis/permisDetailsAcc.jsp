	...
	<body>
		...
		<div class="container" style="margin-top: 140px;">
          ...
          <%
    			...
    			PermisAcces p = (PermisAcces)request.getAttribute("permis");
          ...
          <table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      <th scope="row">FORMALITE SANITAIRE</th>
			      <td>
			      	<%=((PermisAcces)p).getAccFormaliteSanitaire()%>
				  </td>
			    </tr>
			    ...
			    <tr>
			      ...
			      <td>
			      		<%=((PermisAcces)p).getAccPrecautions()%>
				  </td>
			    </tr>
			    
			    <tr>
			      <th scope="row">PRESCRIPTION IMPOSE PAR ORGANE</th>
			      <td>
			      		<%=((PermisAcces)p).getAccPrescription()%>
				  </td>
			    </tr>
