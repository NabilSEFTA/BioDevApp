	...
	<body>
		...
		<div class="container" style="margin-top: 140px;">
          <div class="row justify-content-center">
          	<dir class="" ></dir>
            <center><h1>Details de Permis de circulation </h1></center>
          <%
          	
	          
          	
    			PermisCirculation p = (PermisCirculation)request.getAttribute("permis");
          ...
          <table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      <th scope="row">MOTYEN DE TRANSPORT</th>
			      <td>
			      	<%=((PermisCirculation)p).getCirMoyTransport()%>
				  </td>
			    </tr>
			    
			    <tr>
			      <th scope="row">ITINERAIRE</th>
			      <td>
			      		<%=((PermisCirculation)p).getCirItineraire()%>
				  </td>
			    </tr>
