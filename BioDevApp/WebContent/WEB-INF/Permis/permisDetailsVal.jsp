	...
	<body>
		...
		<div class="container" style="margin-top: 140px;">
          <div class="row justify-content-center">
          	<dir class="" ></dir>
            <center><h1>Details de Permis de valorisation </h1></center>
          <%
          	
	          
          	
    			PermisValorisation p = (PermisValorisation)request.getAttribute("permis");
          ...
          <table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			     ...
			     <tr>
			      <th scope="row">DESTINATION DES PRODUITS</th>
			      <td>
			      	<%=((PermisValorisation)p).getValDestProduit()%>
				  </td>
			    </tr>
			    
			    <tr>
			      <th scope="row">MARCHE ENVISAGE</th>
			      <td>
			      		<%=((PermisValorisation)p).getValMarche()%>
				  </td>
			    </tr>
